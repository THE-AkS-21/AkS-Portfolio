...
// Step 1: All SVG icon components are consolidated here.
...
// Step 2: The single source of truth for all icons and their properties.
const ICONS: Record<string, { component: React.ReactNode; color: string; keywords: string[] }> = {
    ...
    GITHUB: { component: <IconGitHub />, color: '#ffffff', keywords: ['github'] },
    LINKEDIN: { component: <IconLinkedIn />, color: '#0A66C2', keywords: ['linkedin'] },

    // Technologies (add the new entries)
    ...
    // ... add all your other technologies here
